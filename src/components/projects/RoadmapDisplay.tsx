...
export default function RoadmapDisplay({ weeks }: RoadmapDisplayProps) {
  ...
  if (!weeks || weeks.length === 0) {
    return <p className="text-slate-400 text-sm">No roadmap generated yet.</p>
  }
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <div className="text-left">
                <span className="font-medium text-slate-800 text-sm">Week {week.week}</span>
          ...
          {openWeek === week.week && (
            <div className="px-4 pb-4 bg-slate-50 border-t border-slate-100">
              <div className="grid md:grid-cols-3 gap-4 mt-3">
                ...
                <div>
                  <p className="text-xs font-semibold text-slate-500 uppercase tracking-wide mb-2">Owner Roles</p>
                  <ul className="space-y-1">
